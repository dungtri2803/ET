...
function CareerJob() {
  ...
  return (
    ...
    <section className={styles.CareerJobSection}>
      <div className={styles.CareerJob}>
        ...
        <div className={styles.CareerJobList}>
          <div className={styles.CareerJobContentList} >
            <div className={styles.CareerJobContentItem}>
              ...
              <div className={styles.CareerJobItemBtn}>
                <button onClick={() =>showOpenModal(true)}>{`APPLY`}</button>
                {showJob ? <BsChevronDown className={styles.CareerJobIcon}/> : <BsChevronRight className={styles.CareerJobIcon} />  }
              </div>
            </div>
          </div>
          {showJob && <div className={styles.CareerJobContentDetail}>
          ...
          <div className={styles.CareerJobContentList} onClick= {() =>setShowJob1(!showJob1)}>
            <div className={styles.CareerJobContentItem}>
              <div className={styles.CareerJobItemTitle}>
                <p>{`Fullstack (Javascript/Nodejs/Reactjs)`}</p>
                <div className={styles.CareerJobItemDesD}>
              ...
              <div className={styles.CareerJobItemBtn}>
                ...
                {showJob1 ?<BsChevronDown className={styles.CareerJobIcon}/> : <BsChevronRight className={styles.CareerJobIcon} />  }
              </div>
            </div>
          </div>
          {showJob1 && <div className={styles.CareerJobContentDetail}>
            <div className={styles.CareerJobContentDetailGr}>
              <ul className={styles.CareerRequest}>
                <p>{`Request`}</p>
                <li>
          ...
          <div className={styles.CareerJobContentList} onClick= {() =>setShowJob2(!showJob2)}>
            <div className={styles.CareerJobContentItem}>
              <div className={styles.CareerJobItemTitle}>
                <p>{`Fullstack (Javascript/Nodejs/Reactjs)`}</p>
                <div className={styles.CareerJobItemDesD}>
              ...
              <div className={styles.CareerJobItemBtn}>
                <Link href="/career-detail"><button>{`APPLY`}</button></Link>
                {showJob2 ?<BsChevronDown className={styles.CareerJobIcon}/> : <BsChevronRight className={styles.CareerJobIcon} />  }
              </div>
            </div>
          </div>
          {showJob2 && <div className={styles.CareerJobContentDetail}>
            <div className={styles.CareerJobContentDetailGr}>
              <ul className={styles.CareerRequest}>
                <p>{`Request`}</p>
                <li>
          ...
          <div className={styles.CareerJobContentList} onClick= {() =>setShowJob3(!showJob3)}>
            <div className={styles.CareerJobContentItem}>
              <div className={styles.CareerJobItemTitle}>
                <p>{`Fullstack (Javascript/Nodejs/Reactjs)`}</p>
                <div className={styles.CareerJobItemDesD}>
              ...
              <div className={styles.CareerJobItemBtn}>
                <Link href="/career-detail"><button>{`APPLY`}</button></Link>
                {showJob3 ?<BsChevronDown className={styles.CareerJobIcon}/> : <BsChevronRight className={styles.CareerJobIcon} />  }
              </div>
            </div>
          </div>
          {showJob3 && <div className={styles.CareerJobContentDetail}>
            <div className={styles.CareerJobContentDetailGr}>
              <ul className={styles.CareerRequest}>
                <p>{`Request`}</p>
                <li>
          ...
          <div className={styles.CareerJobContentList} onClick= {() =>setShowJob4(!showJob4)}>
            <div className={styles.CareerJobContentItem}>
              <div className={styles.CareerJobItemTitle}>
                <p>{`Fullstack (Javascript/Nodejs/Reactjs)`}</p>
                <div className={styles.CareerJobItemDesD}>
              ...
              <div className={styles.CareerJobItemBtn}>
                <Link href="/career-detail"><button>{`APPLY`}</button></Link>
                {showJob4 ?<BsChevronDown className={styles.CareerJobIcon}/> : <BsChevronRight className={styles.CareerJobIcon} />  }
              </div>
            </div>
          </div>
          {showJob4 && <div className={styles.CareerJobContentDetail}>
            <div className={styles.CareerJobContentDetailGr}>
              <ul className={styles.CareerRequest}>
                <p>{`Request`}</p>
                <li>
    ...
    <section className={styles.CareerJobSectionMobile}>
      <div className={styles.CareerJob}>
        <div className={styles.CareerJobContent}>
          <div className={styles.CareerJobTitle}>
            <p>{`We are looking for`}</p>
