                    ...
                    <div className={styles.TestimonialRight}>
                        <div className={styles.TestimonialRightContent}>
                            <div className={styles.TestimonialRightDes}>
                                <p>Congue sapien lorem nunc, odio faucibus faucibus pulvinar morbi. Morbi proin a vestibulum tellus tellus quam sed. Praesent quisque euismod blandit amet. Volutpat sit venenatis, posuere ornare ac, amet amet malesuada. Odio consequat facilisi vel enim id pellentesque euismod. Ultricies sagittis vivamus eget est.</p>
                            </div>
                            ...
                            <div className={styles.TestimonialRightIcons}>
                                 <button className={styles.TestimonialIconLeft}><Image src={Left} alt="" /></button>
                                 <button className={styles.TestimonialIconRight}><Image src={Right} alt="" /></button>
                            </div>
                        </div>
                    </div>
                </div>
